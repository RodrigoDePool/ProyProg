/*------------------------------------------------------------------
   ...
   (C) Simone Santini, Juan Riera, Rodrigo Riol, Lucia Asencio, Carlos Isasa Platanito 2016

   This file contains the functions that create and manage the
   interface of the game. The interface has three windows: a map window,  an info window and a commnd line. 
   The game window displays a player and one or
